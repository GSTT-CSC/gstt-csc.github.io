...
summary: AI lung nodule detection in CT.
...
This project has been withdrawn. A horizon scan at the time identified multiple commercial AI products that were deemed suitable for resolving this clinical problem, but clinical needs shifted, and it became deprioritised.
This project may be revisited at a later date, but it is not currently being actively worked on.
...
<h3>Goals</h3> An automated computer-aided diagnostic tool integrated with the low-dose chest CT protocol that accurately detects and characterises lung nodules and reports the patient for further investigation, resulting in a more streamlined workflow that is efficient at screening for lung cancer.
